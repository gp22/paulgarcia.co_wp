...
?>
		...
		<footer id="footer" class="bg-gray-300">
			<div class="container mx-auto px-6 pt-12 pb-6 relative">

				<h4 class="text-xl text-white mb-6 relative">Ready to talk about your next project or just have questions?</h4>

				<a class="bg-white text-gray-300 border-4 border-white inline-block mb-16 pl-3 pr-8 py-1 relative rounded-sm uppercase  hover:text-white hover:bg-gray-300  transition cta-button" href="https://harmonizely.com/paulgarcia/phone-call" target="_blank" rel="noopener noreferrer">
					<span class="font-bold tracking-wider">Book a chat</span>
					<svg width="14.848" height="14.848" viewBox="0 0 14.848 14.848" class="text-gray-300 fill-current absolute  phone-solid"><path d="M14.3.7L11.284 0a.7.7 0 00-.8.4L9.093 3.658a.694.694 0 00.2.812l1.757 1.438a10.748 10.748 0 01-5.139 5.139L4.473 9.29a.7.7 0 00-.812-.2L.413 10.482a.7.7 0 00-.406.8L.7 14.3a.7.7 0 00.679.539A13.454 13.454 0 0014.838 1.381.7.7 0 0014.3.7z" transform="translate(.01 .011)"></path></svg>
				</a>

				<div class="md:flex md:items-baseline">
					<span class="flex mb-2  md:mb-0">

						<a class="mr-3 text-white fill-current hover:opacity-75  transition" href="mailto:hello@paulgarcia.co">
							<svg width="32" height="24" viewBox="0 0 32 24"><path d="M31.394 71.925a.376.376 0 01.606.294V85a3 3 0 01-3 3H3a3 3 0 01-3-3V72.225a.374.374 0 01.606-.294c1.4 1.088 3.256 2.469 9.631 7.1 1.319.963 3.544 2.988 5.762 2.975 2.231.019 4.5-2.05 5.769-2.975 6.376-4.631 8.226-6.018 9.626-7.106zM16 80c1.45.025 3.537-1.825 4.587-2.587 8.294-6.019 8.925-6.544 10.837-8.044A1.5 1.5 0 0032 68.188V67a3 3 0 00-3-3H3a3 3 0 00-3 3v1.188a1.5 1.5 0 00.575 1.181c1.912 1.494 2.544 2.025 10.837 8.044 1.05.762 3.138 2.612 4.588 2.587z" transform="translate(0 -64)"></path></svg>
						</a>

						<a class="mr-3 text-white fill-current hover:opacity-75  transition" href="https://github.com/gp22" target="_blank" rel="noopener noreferrer">
							<svg width="24" height="24" viewBox="0 0 24 24"><path d="M21.429 32H2.571A2.572 2.572 0 000 34.571v18.858A2.572 2.572 0 002.571 56h18.858A2.572 2.572 0 0024 53.429V34.571A2.572 2.572 0 0021.429 32zm-6.574 20.555c-.45.08-.616-.2-.616-.429 0-.289.011-1.768.011-2.963a2.087 2.087 0 00-.605-1.645c1.982-.22 4.071-.493 4.071-3.916a2.75 2.75 0 00-.916-2.089 3.35 3.35 0 00-.091-2.411c-.745-.23-2.448.959-2.448.959a8.427 8.427 0 00-4.457 0S8.1 38.873 7.355 39.1a3.325 3.325 0 00-.091 2.411 2.691 2.691 0 00-.835 2.089c0 3.407 2 3.7 3.98 3.916a1.942 1.942 0 00-.568 1.195 1.88 1.88 0 01-2.588-.745 1.866 1.866 0 00-1.366-.916c-.868-.011-.059.546-.059.546.579.268.986 1.3.986 1.3.52 1.591 3.005 1.055 3.005 1.055 0 .745.011 1.955.011 2.175s-.161.509-.616.429a8.888 8.888 0 01-6.014-8.48 8.5 8.5 0 018.679-8.652 8.691 8.691 0 018.9 8.652 8.806 8.806 0 01-5.924 8.48zM9.6 49.282c-.1.021-.2-.021-.209-.091s.059-.15.161-.171.2.032.209.1-.054.139-.161.161zm-.509-.048c0 .07-.08.129-.187.129s-.2-.048-.2-.129.08-.129.188-.129.199.049.199.129zm-.734-.059c-.021.07-.129.1-.22.07s-.171-.1-.15-.171.129-.1.22-.08c.107.032.177.113.15.182zm-.657-.289c-.048.059-.15.048-.23-.032s-.1-.171-.048-.22.15-.048.23.032.094.177.048.22zm-.489-.486c-.048.032-.139 0-.2-.08s-.059-.171 0-.209.15-.011.2.07a.157.157 0 010 .219zm-.348-.52c-.048.048-.129.021-.187-.032-.059-.07-.07-.15-.021-.188s.129-.021.188.032c.057.069.068.149.019.187zm-.359-.4a.1.1 0 01-.15.021c-.07-.032-.1-.091-.08-.139a.126.126 0 01.15-.021c.069.039.101.098.076.141z" transform="translate(0 -32)"></path></svg>
						</a>

						<a class="text-white fill-current hover:opacity-75  md:mr-3  transition" href="https://www.linkedin.com/in/paulgarcia22" target="_blank" rel="noopener noreferrer">
							<svg width="24" height="24" viewBox="0 0 24 24"><path d="M22.286 32H1.709A1.722 1.722 0 000 33.73v20.54A1.722 1.722 0 001.709 56h20.577A1.726 1.726 0 0024 54.27V33.73A1.726 1.726 0 0022.286 32zM7.254 52.571H3.7V41.118h3.559v11.453zM5.475 39.554a2.063 2.063 0 112.063-2.062 2.063 2.063 0 01-2.063 2.062zm15.112 13.017H17.03V47c0-1.329-.027-3.037-1.848-3.037-1.854 0-2.137 1.446-2.137 2.941v5.668H9.488V41.118H12.9v1.564h.048a3.747 3.747 0 013.37-1.848c3.6 0 4.27 2.373 4.27 5.459z" transform="translate(0 -32)"></path></svg>
						</a>

					</span>

					<p class="text-white text-xs">© <!-- -->2020<!-- --> design and development by Paul Garcia</p>
				</div>
